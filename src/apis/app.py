...
def home(request: Request):
    ...
    game_setup = create_random_setup(canvas_x_size, canvas_y_size, number_figures=n_figures, different_lens=different_lens)
...
if __name__ == "__main__":
    ...
    uvicorn.run("src.apis.app:app", host="0.0.0.0", port=5000, reload=True)